...
/**
 *  @brief  CMSPseudoLayerCalculator class
 */
class CMSPseudoLayerCalculator : public pandora::PseudoLayerPlugin
{
public:
    /**
...
inline unsigned int CMSPseudoLayerCalculator::GetPseudoLayerAtIp() const
{
