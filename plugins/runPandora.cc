...
void runPandora::ProcessRecHits(edm::Handle<reco::PFRecHitCollection> PFRecHitHandle, int isubdet, const CaloSubdetectorGeometry* geom, CalibCalo* calib, int& nCaloHits, int& nNotFound, reco::Vertex& pv,
